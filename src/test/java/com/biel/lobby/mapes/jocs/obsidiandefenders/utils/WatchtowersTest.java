...
public final class WatchtowersTest {
    ...
    void launchersAndTrajectories() {
        ...
        require(purchases.purchase(0, 1, 0, pay) == TeamUpgrades.Purchase.ENEMY, "enemy cannot buy");
        require(payments[0] == 0, "enemy attempt has no side effects");
        require(purchases.purchase(0, 0, 0, pay) == TeamUpgrades.Purchase.FAILED, "49 gold fails");
        ...
        require(purchases.purchase(0, 0, 0, pay) == TeamUpgrades.Purchase.BOUGHT, "50 gold buys");
        ...
        require(purchases.purchase(0, 0, 0, pay) == TeamUpgrades.Purchase.LOADING, "second/offhand purchase cannot charge again");
        ...
        require(Watchtowers.passenger(buyer, List.of()) == null, "empty plates select nobody");
        var waiting = List.of(new Watchtowers.Waiting(friend, 1), new Watchtowers.Waiting(buyer, 10));
        require(Watchtowers.passenger(buyer, waiting).equals(buyer), "self-launch takes priority");
        require(Watchtowers.passenger(enemy, waiting).equals(friend), "lower button launches longest waiting participant");
        require(Watchtowers.passenger(enemy, List.of(new Watchtowers.Waiting(friend, 1),
        ...
        require(LauncherTrajectory.find(tower, origin, terrain) == null, "blocked corridor refuses unsafe impulse");
